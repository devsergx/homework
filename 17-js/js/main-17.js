...
// if (!isNaN(isEven)) {
// 	if (isEven % 2 === 0) {
// 		alert(`Число ${isEven} четное`);
// 	} else {
// 		alert(`Число ${isEven} не четное`);
// 	}
// } else {
...
// const weightOfParcel = +prompt("Введите вес посылки (в килограммах)", 0);
// const typeOfDelivery = prompt(
...
// } else if (
// 	typeOfDelivery !== "Стандарт" &&
// 	typeOfDelivery !== "Экспресс" &&
// 	typeOfDelivery !== "Премиум"
// ) {
// 	alert("Неверный тип доставки");
// } else {
// 	const baseCost = weightOfParcel < 1 ? 5 : weightOfParcel <= 5 ? 10 : 15;
